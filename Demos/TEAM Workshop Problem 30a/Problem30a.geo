...
//+
Physical Surface("Rotor Steel", 1) = {6};
//+
Physical Surface("Rotor Aluminum", 2) = {12};
//+
Physical Surface("A", 3) = {20};
//+
Physical Surface("-A", 4) = {26};
//+
Physical Surface("B", 5) = {28};
//+
Physical Surface("-B", 6) = {22};
//+
Physical Surface("C", 7) = {24};
//+
Physical Surface("-C", 8) = {30};
//+
Physical Surface("Stator Steel", 9) = {32};
//+
Physical Surface("Air Gap to Rotor", 10) = {18};
//+
Physical Surface("Air Gap to Stator", 11) = {19};
//+
Physical Surface("Air Between Coils", 12) = {21, 23, 25, 27, 29, 31};
//+
