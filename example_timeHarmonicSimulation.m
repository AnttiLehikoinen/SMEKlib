...
DRr = sparsediag(760.000E-03 ./(dims.sigma_rotor*cAr)); %resistance matrix
...
DRs = sparsediag(760.000E-03 ./(dims.sigma_stator*cAs)) / dims.fillingFactor; %resistance matrix
